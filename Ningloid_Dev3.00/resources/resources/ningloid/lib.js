...
(function($){
    ...
    $.storeFile = (key, data) => {
        ...
        */
        ...
        // 正規データ
        fs.writeFileSync(`${outPath}/resources/game/${key}.sav`, escape(data));
    };
    ...
    $.getStoreFile = (key) => {
        ...
        try {
            ...
            */
            ...
            // 正規データ
            if (fs.existsSync(`${outPath}/resources/game/${key}.sav`) ){
                const data = fs.readFileSync(`${outPath}/resources/game/${key}.sav`);
                jsonData = JSON.parse(unescape(data));
            } else {
                jsonData = JSON.parse(unescape(localStorage.getItem(key)));
            }

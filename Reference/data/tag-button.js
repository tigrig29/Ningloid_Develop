...
// tag_data.kind_of_button = {
// 	overview: "ボタン関連",
// 	tag: {
// 		"button":{
// 			name: "button",
// 			overview: "ボタンの作成",
// 			description: "ボタンを作成します。storageパラメータやtargetパラメータでシナリオジャンプ機能、roleパラメータでセーブ機能やロード機能など、様々な役割をもたせることが可能です。",
// 			develop_info: [
// 				"仮実装", "-", "・storageパラメータ、targetパラメータによるシナリオジャンプ機能実装<br>・roleパラメータの指定可能role増やす"
// 			],
// 			parameter:[
// 				{
